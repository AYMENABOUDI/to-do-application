...
<div class="col-md-7">
<span class="mt-4 pagetitle" >My day - @include('layouts.day')</span>
</div>
<div class="col-md-5" style="text-align:right;">
<a id="pagetitleprimerlink" href="{{ route('home') }}">Dashbord /</a>
<a id="pagetitleprimerlink" href="{{ route('myday.index') }}">My day /</a>
...
<div class="form-group row">
			...
			<div class="col-sm-6">
             ...
             <input type="hidden" class="form-control" id="task_date" name="task_date" value="{{ $task->task_date }}" required="">
             </div>
