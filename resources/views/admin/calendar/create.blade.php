...
@section('title', 'Manage Calendar - new event')
@section('content')
...
<input type="hidden" name="etats" id="etats" value="0">
		...
		<input type="hidden" name="etatsdate" id="etatsdate" value="{{ date('Y-m-d') }}">
			...
			<div class="col-sm-6">
                    ...
                    <input type="date" class="form-control" id="task_date" name="task_date" value="" required="">
             </div>
			 

                    <input type="hidden" class="form-control" id="task_enddate" name="task_enddate" value="0" required="">
			</div>
